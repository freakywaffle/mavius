...
//    	 console.log("hello");
     ...
     var type = modal.querySelector('select[name="type"]');
     ...
     reportBtn.onclick = function(e){
        ...
        var txttype = type.value;
        var request = new XMLHttpRequest();
       // console.log("hello");
        request.open("POST", "../../../../admin/report", false);
		request.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		request.onload = function(){
//        console.log(txtcontent);
//        console.log(txtcontentEtc);
//        console.log(txttype);
		// console.log("requestReady: "+request.readyState);
		// console.log("responseText: "+request.responseText)
		//true, flase
		// alert(request.responseText);
		 //checkedId=!JSON.parse(request.responseText);
        if(txtcontent=="선택해주세요."||txttype=="선택해주세요."){
        	alert("종류를 선택해주세요.");
        	return;
        	}
        else 
