	...
	<div id="hiririk">
		...
		<div class="wrapper">
			<section class="board-header">
				<h1 class="border-title text-center font-medium"><a href="list">MAGICIAN</a></h1>
				...
				<div class="main-page block-flex margin-top">
					<div>
						...
						<div class="simbol action">
							<img onclick="location.href='list?category=아크(썬콜)'" alt="아크(썬콜)" src="/images/catalog1.png">
						</div>
						<div class="simbol action">
							<img onclick="location.href='list?category=아크(불독)'" alt="아크(불독)" src="/images/catalog2.png">
						</div>
						<div class="simbol action">
							<img onclick="location.href='list?category=비숍'" alt="비숍" src="/images/catalog3.png">
						</div>
						<div class="simbol action">
							<img onclick="location.href='list?category=루미너스'" alt="루미너스" src="/images/catalog4.png">
						</div>
						<div class="simbol action">
							<img onclick="location.href='list?category=플레임위자드'" alt="플레임위자드" src="/images/catalog5.png">
						</div>
					</div>
