	...
	<div id="hiririk">
		...
		<div class="wrapper">
			<section class="board-header">
				<h1 class="border-title text-center font-medium"><a href="list">WARRIOR</a></h1>
				...
				<div class="main-page block-flex margin-top">
					<div>
						...
						<div class="simbol action">
							<img onclick="location.href='list?category=히어로'" alt="히어로" src="/images/catalog1.png">
						</div>
						<div class="simbol action">
							<img onclick="location.href='list?category=다크나이트'" alt="다크나이트" src="/images/catalog2.png">
						</div>
						<div class="simbol action">
							<img onclick="location.href='list?category=팔라딘'" alt="팔라딘" src="/images/catalog3.png">
						</div>
						<div class="simbol action">
							<img onclick="location.href='list?category=미하일'" alt="미하일" src="/images/catalog4.png">
						</div>
						<div class="simbol action">
							<img onclick="location.href='list?category=소울마스터'" alt="소울마스터" src="/images/catalog5.png">
						</div>
					</div>
