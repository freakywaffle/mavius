	...
	<div id="hiririk">
		...
		<div class="wrapper">
			<section class="board-header">
				<h1 class="border-title text-center font-medium"><a href="list">PIRATE</a></h1>
				...
				<div class="main-page block-flex margin-top">
					<div>
						...
						<div class="simbol action">
							<img onclick="location.href='list?category=바이퍼'" alt="바이퍼" src="/images/catalog1.png">
						</div>
						<div class="simbol action">
							<img onclick="location.href='list?category=캡틴'" alt="캡틴" src="/images/catalog2.png">
						</div>
						<div class="simbol action">
							<img onclick="location.href='list?category=엔젤릭버스터'" alt="엔젤릭버스터" src="/images/catalog3.png">
						</div>
						<div class="simbol action">
							<img onclick="location.href='list?category=아크'" alt="아크" src="/images/catalog4.png">
						</div>
						<div class="simbol action">
							<img onclick="location.href='list?category=메카닉'" alt="메카닉" src="/images/catalog5.png">
						</div>
					</div>
