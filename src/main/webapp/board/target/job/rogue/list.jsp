	...
	<div id="hiririk">
		...
		<div class="wrapper">
			<section class="board-header">
				<h1 class="border-title text-center font-medium"><a href="list">ROGUE</a></h1>
				...
				<div class="main-page block-flex margin-top">
					<div>
						...
						<div class="simbol action">
							<img onclick="location.href='list?category=나이트로드'" alt="나이트로드" src="/images/catalog1.png">
						</div>
						<div class="simbol action">
							<img onclick="location.href='list?category=섀도어'" alt="섀도어" src="/images/catalog2.png">
						</div>
						<div class="simbol action">
							<img onclick="location.href='list?category=나이트워커'" alt="나이트워커" src="/images/catalog3.png">
						</div>
						<div class="simbol action">
							<img onclick="location.href='list?category=듀얼블레이드'" alt="듀얼블레이드" src="/images/catalog4.png">
						</div>
						<div class="simbol action">
							<img onclick="location.href='list?category=팬텀'" alt="팬텀" src="/images/catalog5.png">
						</div>
					</div>
